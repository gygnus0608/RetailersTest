      ...
      async AddShopCart(){
        try{
          ...
          await this.$store.dispatch('AddOrUpdateShopCart',{
            ...
            // console.log(JSON.stringify(this.skuInfo));
            // 文档中规定路由只能带id和num传递参数，所以skuinfo的数据要通过JSON传递
            // 带参：利用会话存储把skuinfo这个对象转成字符串传递到AddCartSuccess组件中
